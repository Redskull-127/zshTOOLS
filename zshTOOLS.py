...
More.add_command(label = 'CLEAR', command = clr, activebackground='red')
...
More.add_command(label = 'REBOOT', command=reboot, activebackground='red')

More.add_command(label = 'EXIT', command = exittest, activebackground='red')
...
def addClick():
	...
	sub_btn = tk.Button(r, text = 'Go', command = exploit, bg ='black',fg='white' ,activeforeground='red').pack()
...
MSF.add_command(label = 'ARMITAGE \n MSF - GUI', command = armitage, activebackground='red')
...
SCAN.add_command(label = 'SCAN Networks \n USING WASH (WPS)', command = scannetw, activebackground='red')
SCAN.add_separator()
...
SCAN.add_command(label = 'IP SCANNER', command = angryip, activebackground='red')
...
SCAN.add_command(label = 'START Monitor Mode', command = monitoron, activebackground='red')
...
SCAN.add_command(label = 'STOP Monitor Mode', command = monitoroff, activebackground='red')
...
MAC.add_command(label='RANDOM MAC', command = ranmac, activebackground='red')
...
MAC.add_command(label = 'CUSTOM MAC', command = cusmac, activebackground='red')
...
MAC.add_command(label = 'PERMANENT MAC', command=permac, activebackground='red')
...
def others():
	...
	kdebt = tk.Button(r1, text = 'KDE CONNECT', activebackground='red', width = 30, command = kde)
	kdebt.pack()
	...
	def code():
		...
		mixer.music.play()
		os.system("code")
	codebt = tk.Button(r1, text = 'VS CODE', activebackground='red', width=30, command = code)
	codebt.pack()
	...
	edex = tk.Button(r1, text = 'eDEX - UI', activebackground='red', width=30, command=eDEX)
	edex.pack()
	...
	visitbt = tk.Button(r1, text = 'VISIT US', activebackground = 'red',width = 30, command = visitus)
	visitbt.pack()
	...
	donatebt = tk.Button(r1, text = 'DONATE US', activebackground='red',width = 30, command=DONATE)
	donatebt.pack()
